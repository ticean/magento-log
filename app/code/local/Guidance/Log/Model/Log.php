 ...
 * Logging event model
 */
class Guidance_Log_Model_Log extends Mage_Core_Model_Abstract
{
    ...
    {
        $html  = str_replace("\n","<br/>", $this->getLogId())."<br/>";
        $html .= str_replace("\n","<br/>", $this->getTimestamp())."<br/>";
        $html .= str_replace("\n","<br/>", $this->getLogger())."<br/>";
        $html .= str_replace("\n","<br/>", $this->getLevel())."<br/>";
        $html .= str_replace("\n","<br/>", $this->getAdditionalInfo())."<br/>";
        return $html;
    }
}
